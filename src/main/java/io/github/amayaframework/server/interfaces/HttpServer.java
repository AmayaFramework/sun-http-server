 ...
 * The subclass {@link HttpsServer} implements a server which handles HTTPS requests.
 * <p>
...
public interface HttpServer {
     ...
     * URI path to an exchange handler on this HttpServer. Once created, all requests
